    ...
    <div className="container mx-auto py-16 px-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-8 md:space-y-0 md:space-x-12 pt-10">
        <div className="md:w-1/3">
          <h2 className="text-4xl font-semibold mb-4">Convert Files</h2>
        ...
        <div className="md:w-1/3">
          <h2 className="text-4xl font-semibold mb-4">Extract Content</h2>
          <p className="text-3xl">
        ...
        <div className="md:w-1/3">
          <h2 className="text-4xl font-semibold mb-4">Flexible and User-Friendly</h2>
          <p className="text-3xl">
